...
const UnlockPDF: React.FC<UnlockPDFProps> = ({ tool, onBack }) => {
    ...
    const handleFileSelect = async (file: File) => {
        ...
        try {
            ...
            if (!encrypted) {
                setError('This PDF is not encrypted. No password needed!');
            }
        } catch (err) {
    ...
    const handleUnlock = async () => {
        ...
        try {
            ...
            downloadPDF(unlockedPdfBytes, filename);
            ...
            <div className="tool-content">
                {!selectedFile ? (
                    ...
                    >
                        ...
                        <p className="upload-text">Click or drag encrypted PDF file here</p>
                        <p className="upload-subtext">Remove password protection from your PDF</p>
                        <input
                            ref={fileInputRef}
                            type="file"
                    ...
                    <div className="process-section">
                        <div className="file-info">
                            ...
                            <div className="file-details">
                                ...
                                {isEncrypted !== null && (
                                    <div className={`encryption-status ${isEncrypted ? 'encrypted' : 'not-encrypted'}`}>
                        ...
                        {processState === 'idle' && isEncrypted && (
                            <div className="password-section">
                                ...
                                <div className="password-tips">
                                    ...
                                    <ul>
                                        <li>Enter the password that was used to encrypt this PDF</li>
                                        <li>The password is case-sensitive</li>
                                        <li>After unlocking, the PDF will be saved without password protection</li>
                                    </ul>
                                </div>
                            </div>
                        )}
                        ...
                        {processState === 'completed' && (
                            <div className="success-message">
                                ...
                                <p>PDF unlocked successfully!</p>
                                <p className="success-subtext">
                                    Your unlocked PDF has been downloaded.
                                </p>
                            </div>
                        )}
